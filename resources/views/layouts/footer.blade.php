<footer class="main-footer">
    <div class="footer-left">
      Copyright &copy; 2023 <div class="bullet"></div> Design By <a href="https://www/">Ahmad Haidar Shiddiq</a>
    </div>
...
<script src="{{ asset('dist/assets/modules/dropzonejs/min/dropzone.min.js') }}"></script>

<!-- Page Page -->
<script src="{{ asset('dist/assets/js/page/modules-chart.js') }}"></script>
